...
const Menu1 = () => {
  ...
  return (
    <div className='h-auto py-16 bg-white lg:min-h-screen flex flex-col justify-center items-center'>
      ...
      <div className='grid  lg:p-4  mb-12 sm:grid-cols-3 lg:grid-cols-2 w-11/12 lg:gap-0 gap-10  lg:w-3/4 mx-auto mt-12'>
        {images.map((val, i) => (
          <div key={i} className='group   overflow-hidden hover:border-gray-400 transition-all duration-300'>
