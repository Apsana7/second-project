      ...
      <div className=' flex flex-col  items-center justify-center w-3/5 mx-auto'>
        ...
        <div className='flex w-full '>
          <div className='flex  w-full h-96 '>
            <img src="Person3.jpg" alt="" className='absolute h-1/2 w-64 object-cover z-10 my-8 mx-64 drop-shadow-lg'/>
            <img src="Person5.jpg" alt="" className='relative drop-shadow-lg' />
          </div>
          ...
          <div className='flex flex-col gap-4 w-3/4 '>
            ...
            <div className='font-bold text-3xl text-orange-300'>+1-978-123-4567</div>
          </div>
        </div>
        ...
        <div className='grid grid-cols-5 py-12'>
          <div>
            <CountUp start={0} duration={5} end={18} className='text-3xl font-bold text-orange-300' />
            <div className='text-sm font-thin text-gray-500'>YEARS OF EXPERIENCES</div>
          </div>

          <div>
            <CountUp start={0} end={100} className='text-3xl font-bold text-orange-300' />
            <div className='text-sm font-thin text-gray-500'>MENUS/DISH</div>
          </div>

          <div>
            <CountUp start={0} end={50} className='text-3xl font-bold text-orange-300' />
            <div className='text-sm font-thin text-gray-500'>STAFFS</div>
          </div>

          <div>
            <CountUp start={0} end={15000} className='text-3xl font-bold text-orange-300'/>
